class QuizSetup {
  ...
  fetchQuestions() {
    ...
    fetch(
      "https://quizapi.io/api/v1/questions?apiKey=7XRH2oR7PfuWCijQLCYIFvRXdtIDwumiF1eyWpbg&limit=10"
    )
      ...
      .then((data) => {
        ...
        let quizArray = dataArray.map((obj) => {
          // gör en ny array med objact om endast inehåller de egenskaper vi behöver.
  ...
  displayGame() {
    ...
    heading.innerText = "Player: " + this.playerName;
...
class QuizGame {
  ...
  nextQuestion() {
    ...
    displayCurrQuestion.innerText = "Question " + this.questionNumber;
